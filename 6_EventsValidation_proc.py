...
for v_cfsv2, v_obs in zip(variables_cfsv2, variables_obs):
    ...
    # ENSO_obs --------------------------------------------------------------- #
    x, y, en_obs = CaseComp(data, 'SON', mmonth=[9, 11], c='N34_pos',
                            two_variables=False)
    x, y, ln_obs = CaseComp(data, 'SON', mmonth=[9, 11], c='N34_neg',
                            two_variables=False)
    ...
    # IOD_obs ---------------------------------------------------------------- #
    x, y, iodp_obs = CaseComp(data, 'SON', mmonth=[9, 11], c='DMI_pos',
                              two_variables=False)
    x, y, iodn_obs = CaseComp(data, 'SON', mmonth=[9, 11], c='DMI_neg',
                              two_variables=False)
